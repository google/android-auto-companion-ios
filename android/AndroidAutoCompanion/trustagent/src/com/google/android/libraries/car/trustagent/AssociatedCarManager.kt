...
internal constructor(
  ...
  /** Removes a car from the stored associated car list. */
  suspend fun clear(deviceId: UUID) {
    database.deleteAssociatedCar(deviceId.toString())
  }

  /** Removes all stored associated cars. */
  suspend fun clearAll() {
    database.deleteAllAssociatedCars()
  }
