...
class NotificationUtilsTest {
  ...
  @Test
  fun messageUserDisplayName_returnsAppropriateName() {
    val sbn = createSBN(hasMessagingStyle = true)
    val userDisplayName = sbn.notification.messageUserDisplayName
    assertThat(userDisplayName.isNullOrEmpty()).isFalse()
    assertThat(userDisplayName).isEqualTo(sbn.notification.messagingStyle?.user?.name)
  }
